        ...
        const testimonials = [
          {
            ...
            review:
              "I 've rented Cars from various companies,but the experience where with carrental was expectional ",
          },
          {
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
      <Title
        ...
        subTitle="Discover why discrening travel choose the stayVenture for their luxury  accomodition around the world."
      />
